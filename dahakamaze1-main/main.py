...
background = transform.scale(image.load("howxn0qns9861.png"), (win_width, win_height))
...
#створюємо спрайти
player = Player('mds31m44jjv51-removebg-preview.png', 5, win_height - 100, 80, 90, 0, 0)
final_sprite = GameSprite('burn.png', win_width - 90, win_height - 100, 90, 90)


monster1 = Enemy('wizzard1.png', win_width - 80, 410, 100, 90, 2, 420, win_width - 85)
monster2 = Enemy('wizzard1.png', win_width - 100, 25, 100, 90, 2, 200, win_width - 85)
